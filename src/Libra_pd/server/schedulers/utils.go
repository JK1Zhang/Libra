...
func dimNeedSched(dimID dimType) bool {
	switch dimID {
	//case readBytesDim, readKeysDim, writeKeysLeaderDim, writeKeysPeerDim, writeBytesPeerDim:
	case readBytesDim, readKeysDim, writeKeysLeaderDim, writeBytesLeaderDim, writeKeysPeerDim, writeBytesPeerDim:
		return true
	default:
		return false
	}
